...
import { AlertTriangle, Dumbbell, Ruler, Save, Settings, Trash2, Trophy, User } from 'lucide-react';
        ...
        <div className='sticky top-24 flex flex-col gap-6 lg:col-span-4'>
          <div className='relative overflow-hidden rounded-2xl border border-black/20 bg-gray-50 p-6 shadow-lg shadow-amber-900/20 dark:border-gray-800 dark:bg-black dark:shadow-pink-500/20'>
            ...
            <div className='relative z-10 flex flex-col items-center gap-2 text-center'>
              ...
              <div className='mt-4 grid w-full grid-cols-2 gap-4 border-t border-black/10 pt-4 dark:border-gray-700'>
                <div className='flex flex-col items-center'>
                  <span className='font-poppins text-2xl font-bold text-amber-900 dark:text-white'>
                    42
                  </span>
                  <span className='font-montserrat flex items-center gap-1 text-xs text-amber-700 dark:text-gray-400'>
                    <Dumbbell className='h-3 w-3' />
                    Workouts
                  </span>
                </div>
                <div className='flex flex-col items-center border-l border-black/10 dark:border-gray-700'>
                  <span className='font-poppins text-2xl font-bold text-amber-900 dark:text-white'>
                    8
                  </span>
                  <span className='font-montserrat flex items-center gap-1 text-xs text-amber-700 dark:text-gray-400'>
          ...
          <div className='relative overflow-hidden rounded-2xl border border-red-200 bg-red-50 p-6 shadow-sm dark:border-red-900/30 dark:bg-red-900/10'>
            ...
            <div className='flex items-center gap-2 text-red-600 dark:text-red-400'>
              ...
              <h3 className='font-montserrat text-sm font-semibold'>Danger Zone</h3>
            </div>
            <p className='font-montserrat mt-2 text-xs text-red-700 dark:text-red-300'>
              Once you delete your account, there is no going back. Please be certain.
            </p>
            <Button
              variant='outline'
              className='mt-4 w-full border-red-300 text-red-600 transition-all hover:bg-red-100 hover:text-red-700 dark:border-red-800 dark:text-red-400 dark:hover:bg-red-900/20'
            >
