        ...
        <section className="container flex h-screen flex-col justify-between overflow-x-hidden">
          <div className="flex grow items-center justify-center px-4 pt-32">
            <div className="max-w-lg text-center">
              ...
              <h1 className="mb-4 text-[48px] font-extrabold text-red-600 dark:text-red-400 sm:text-[64px] md:text-[80px] lg:text-[96px]">
                Error
              </h1>

              <h2 className="mb-4 text-lg font-medium text-gray-900 dark:text-gray-300 sm:text-xl lg:text-2xl">
              ...
              <p className="mb-8 text-sm text-gray-700 dark:text-gray-400 sm:text-base lg:text-lg">
                ...
                inconvenience. Please try refreshing the page or return to the
                home page.
              </p>
