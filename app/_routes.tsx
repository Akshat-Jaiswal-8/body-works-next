  ...
  return (
    <AnimatePresence>
      <Routes location={location} key={location.pathname}>
        ...
        <Route
          path="/exercises"
          element={<Transition Component={<Exercises />} />}
        />
        <Route
          path="/exercises/:exerciseId"
          element={<Transition Component={<Exercise />} />}
        />
        <Route
          path="/equipments"
          element={<Transition Component={<Equipments />} />}
        />
        <Route
          path="/equipments/:equipment"
          element={<Transition Component={<Equipment />} />}
        />
        <Route
          path="/target-muscle"
          element={<Transition Component={<TargetMuscles />} />}
        />
        <Route
        ...
        <Route
          path="/body-parts"
          element={<Transition Component={<BodyParts />} />}
        />
        <Route
          path="/body-parts/:bodypart"
          element={<Transition Component={<BodyPart />} />}
        />

        <Route
          path="/routine-category"
          element={<Transition Component={<RoutineCategory />} />}
        />
        <Route
          path="/routines"
          element={<Transition Component={<Routines />} />}
        />
        <Route
          path="/routines/routine/:id"
          element={<Transition Component={<Routine />} />}
        />
